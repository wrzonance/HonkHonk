...
pub struct WinitState {
    pub drop_devices: super::seat::data_device::DropDevices,
    /// The WlRegistry.
...
impl WinitState {
    pub fn new(
        ...
        let mut drop_devices = super::seat::data_device::DropDevices {
            manager: sctk::data_device_manager::DataDeviceManagerState::bind(globals, queue_handle).ok(),
        ...
        for seat in seat_state.seats() {
            ...
            drop_devices.add(&seat, queue_handle);
        }
